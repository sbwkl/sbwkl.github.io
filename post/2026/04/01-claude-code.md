...
保守来说应该选 WebView 型的 UniApp，前端代码姑且了解过一些，UniApp 也听朋友说起过，还有个伴能问问。但既然是玩，那就玩点激进的。

**Flutter 安装**

安装基本没啥大问题，按照官方文档来就是了，真有问题也是网络问题。网络问题的终极杀招是代理开 Tun Mode，这样所有流量都走代理，如果这招也搞不定，那只有烧香祈福了。

需要注意验证下 Tun Mode 是否开启成功。以 google.com 为例，开启前必须打不开，开启后必须能打开。

有些代理软件，比如我用的黑色猫猫头，每次打开 Tun Mode，要点一下扳手，安装服务，才能真正启用，被它套路过一次。

装完最好装一下 Android Studio，主要是为了 SDK，Android Studio 可以设置代理，第一次装也要下载不少东西。

再然后准备设备，电脑够猛的可以上模拟器，我电脑太烂，出风口可以把鸡蛋吹的比刚出锅还烫。

翻出来一台远古 MI 8 SE 当真机，连上数据线，执行命令
...
无线调试还有个好处，没啥权限问题。用 USB 调试，安装 apk 包，各种失败，这问题那问题的，无线屁事没有。

**开发**

然后是决定做什么，看到老爹最近沉迷短剧，那就做个短剧 app 吧，随便下了个，截了五张图，然后输入
...
截止到最后一次看它，跑了四个多小时，问题依然没有解决，我也不知道它能不能解决。
