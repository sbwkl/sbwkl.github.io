...
一些文章中常常出现的词，一个抽象概念，上面说的 PE，PB 都可以认为是一种估值，也有其他计算方式。估值可以被理解为股民的情绪，大概的公式是：股价 = 公司内在价值 * 估值，短期内公司内在价值不变，影响股估值价的常常是估值。
...
指数编制方案可以在对应的交易所官网可以查到，上证的在数据 》上证指数系列，深圳的在市场服务 》信息服务 》深圳指数。北京好像还没有指数，要么我没找到。

搜上证指数，还能搜索“中证系列指数“和“中华系列指数”，简单看了下[中证指数](https://www.csindex.com.cn)是上海、深证两市共同出资成立的，[中华指数](https://www.cesc.com)是香港、上海、深证三家共同出资成立。我之前都以为中证的中是中间的中。
...
中证指数公司编制，选取的是沪市+深市中剔除沪深 300 的样本，剔除一年日均总市值排行前 300，然后从前往后选 500 个证券。
...
和 Wind 类似的工具还有东方财富旗下的 Choice 价格也一样劝退。估计还有别的数据工具，猜测应该也不便宜，没继续找了。
