...
把这两年接触到术语整理下，以前总说阿里喜欢发明黑话，看看故事，黑话也不少。
...
就是单纯一个抽象概念，我们投资的一般都是 A 股。

除了 A 股还真有叫 B 股的，这个就是买卖用外币，其他每区别。
...
这些交易所有些别名：上交所，上证，深交所，深证，北交所，以至于我听到中证的时候不知道是哪个交易所。

最早的股票交易所可以追溯到 400 多年前成立的[阿姆斯特丹](https://en.wikipedia.org/wiki/Euronext_Amsterdam)。


现在[全世界主要的股票交易所](https://en.wikipedia.org/wiki/List_of_stock_exchanges)，市值前十中国占 3 个位置，分别是第 3，6，7 位。前 2 名是美国的纽约交易所和纳斯达克交易所，好多书上研究股市也是用美股几百年的数据来研究的。
...
我第一个用的券商是东方财富，我用的时候感觉特别怪，在 app 上我要登陆两次，一次是普通的手机号登陆，另一次是券商账号登陆，而且还能切换券商账号。后来问了朋友才知道，东方财富原来是做软件服务的，和同花顺类似，后来才转型成券商。估计是为了兼容才会有这么怪的交互。

纯券商 app 只需要登陆一次，而且也不用切换账号。

**银证转帐**

银行卡的钱转给券商，或者反过来。A 股券商似乎都支持这个功能，港股的不是，只支持几家支持，不支持的银行就真的时把钱转到券商账户的，这么来看还是 A 股更安全点。另外国家好像也不建议直接买卖港股，推荐通过 A 股的基金来买卖。
...
么
公式 PE = 1 股的价格 / 1 股的收入，股价很好查，随便打开一个券商软件都有，收入比较难搞，这个一般要去财报里面扣（有些会有算好的每股收益），而财报明显也不是写给一般人看的，突出一个高深莫测。不过财报里面确实信息量很大，以前有朋友讨论珠宝公司设计、研发费用和打广告费用谁多谁少，然后随便挑了几家的财报看了下，大头是一个叫营业成本的，看的一脸蒙逼，反正研发肯定花不了几个钱。

财报在交易所官网上都能查到，只要找到对应的股票，进入详情页，在相关公告里，一般标题格式是《XXX 报告》。因为财报不容易看也有专门收集整理解读财报的网站。

PE 不太好理解，不过 PE 的倒数蛮好理解的，我理解是投入一块钱能赚多少钱。从这个角度来看 PE 越小越好，仅从这个角度啊，实际情况变幻莫测。
...
账面价值还是要从财报里面扣。PB 的倒数也许是当清算公司的时候，1 块钱还能剩多少钱？

**估值**

一些文章中常常出现的词，一个抽象概念，上面说的 PE，PB 都可以认为是一种估值，也还有其他计算方式。估值可以被理解为股民的情绪，大概的公式是：股价 = 公司内在价值 * 估值，短期内公司内在价值不变，影响股估值价的常常是估值。

**仓位**

投资人能用的资金和投入的资金比例。1W 资金，投资 3k 就是 30%仓位。空仓就是没有投资都是现金，满仓就是全部资金投资。还有更离谱的杠杆，就是借钱投资。这个不是普通人玩得，不然很容易天台见。

**指数**

一大堆股票根据某个算法计算出来的值，用来反映一个整体的情况。上海和深圳都有编制各自的指数，还不少。

指数编制方案可以在对应的交易所官网可以查到，上证的在数据 》上证指数系列，深圳的在市场服务 》信息服务 》深圳指数。北京好像还没有指数，要么我每找到。

搜上证指数，还能搜索“中证系列指数“和“中华系列指数”，简单看了下[中证指数](https://www.csindex.com.cn)时上海、深证两市共同出资成立的，[中华指数](https://www.cesc.com)是香港、上海、深证三家共同出资成立。我之前都以为中证的中是中间的中。

中证指数的官网，在指数详情页面都可以看到编制方案，另外这几个网站搜索功能还不错，至少都能搜出来结果。

我看过的几个指数计算公式都差不多，都是 样本的调整市值 / 除数 * 基点。基点就是这个指数的第一个数据，这样除数就等于在基点时的市值，然后如果没有送股、配股、增发之类的操作，除数不变，实际不可能需要按照指数修正公式修正除数。这份[文档](http://www.sse.com.cn/market/sseindex/calculation/c/5267799.pdf)的第 4 节和附录四详细解释怎么计算。

指数也会有 PE, PB 这些估值，不过算法很多，什么按市值加权的，等权的，如果在不同的 app 看到 PE 大小不同也很正常。大佬们似乎都是用工具自己算的。

**上证指数**

聊天时候说的大盘多少点可能说的是上证指数，这个指数由上海交易所所有符合条件的股票组成，另外这个指数因为长期在 3000 点附近徘徊，于是有 A 股不给力，玩不动这样的说法。另外一些观点说这个指数之所以一直在 3000 点和指数的编制方式有点关系，有些流动性不好的大哥股价迭了需要小弟涨死涨活才能把指数拉上去。
...
这个是中证指数编的，选取的是沪市+深市中市值大、流动性好的最具有代表性的 300 只证券组成，有人称它是尖子班。

**中证500**

这个是中证指数编的，选取的是沪市+深市中剔除沪深 300 的样本，剔除一年日均总市值排行前 300，然后从前往后选 500 个证券。

总的来说叫上证XX一般都是上海交易所的指数，叫深证XX一般是深圳交易所的指数，叫中证XX的一般是上海+深圳的。遇到名字特别奇怪的，去中证指数官网查一下就能了解个大概。

**万德全 A**

某些文章中会出现的术语，正确分词应该是「万德·全A」。万德应该指的是一款牛逼的金融数据分析工具 Wind。全 A 指的是全部 A 股组成的指数。我最开始都念「万德全·A」然后找万德全到底是什么牛逼的股票，最后当然是毛都没找到。

中证里面有个叫中证全指的应该和它类似。

Wind 的价格看着就不是给普通老百姓用的，应该是给专业人士用的，他们要算些有的没的，从这个角度来看散户要直接对抗机构还是有点难的，光信息这一项就弱了不少。

和 Wind 类似的工具还有东方财富旗下的 Choice 价格也一样劝退。应该还有别的数据工具，没继续找了。
...
分红分为「现金分红」和「红利再投资」，现金分红约等于赎回，优点是不需要手续费。红利再投资约等于无事发生，份额多了，价格低了，总没变。

所以一般你想卖了或者觉得估值高了就选现金分红，否则就红利再投资。
...
这类基金看重基金经理。这种基金的基金经理权限大，可以控制整体仓位，可以自己选择要买的股票。约等于是信任基金经理，让他帮忙打理资金。
...
套娃么，递归了解一下。这个好像是伴随着投顾服务整出来的概念。

大概接触了这么多，股市不仅术语多，玩法更多，永远有意想不到的玩法。
