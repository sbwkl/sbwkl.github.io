...
1. There is a state in open.
2. All state in malfunctioning state or diagnostic state.
3. There is a state in open or a state in diagnostic.
4. There is a state not in available.
5. All state not in working.
